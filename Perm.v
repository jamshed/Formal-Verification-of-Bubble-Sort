...
(** Use the above) to prove the following theorem.  These [Check] commands
...
Proof.
 (* After you cancel the [5], then bring the [6] to the front... *)
  intros.
  simpl. Search (_ ++ [] = _). rewrite app_nil_r.
  Check perm_skip. apply perm_skip.
  Check Permutation_app_comm. apply (Permutation_app_comm (6 :: a) b).
Qed.
(** [] *)
...
Proof.
  ...
  Check perm_skip. Check Permutation_cons_inv.
  apply Permutation_cons_inv in contra.
  Check Permutation_length_1_inv. apply Permutation_length_1_inv in contra.
  inversion contra.
Qed.
(** [] *)
